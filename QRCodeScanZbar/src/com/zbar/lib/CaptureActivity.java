...
//	public abstract RelativeLayout getCaptureContainter();
//
//	public abstract RelativeLayout getCaptureCropLayout();
//
//	public abstract ImageView getCaptureScanLine();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 动画速率：匀速
		mAnimation.setInterpolator(new AccelerateInterpolator(2));
		// 设置动画
	...
	public void handleDecode(String qrCodeString) {
		...
		if (captureContainter!=null)
			captureContainter.postDelayed(new Runnable() {
				@Override
				public void run() {
					resetCode();
				}
	...
	public void resetCode(){
		if (handler != null)
			handler.sendEmptyMessage(R.id.restart_preview);//间隔2秒
	}
	/**
	 * 初始化照相机
	 * 
