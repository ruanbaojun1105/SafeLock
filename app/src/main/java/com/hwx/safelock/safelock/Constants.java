...
public class Constants {
    ...
    public static final String SERIAL_PORT_COMMAND_SCAN="SERIAL_PORT_COMMAND_SCAN";//二维码接收
    public static final String SERIAL_PORT_SEND="SERIAL_PORT_SEND";//发送的数据
    public static final String SERIAL_PORT_CONNECT_FAIL="SERIAL_PORT_CONNECT_FAIL";//连接失败
    ...
    public static final int SCREEN_TIME_OUT=300000;//屏幕超时自动退出
    ...
    public static String VIDEO_DO_INIT="VIDEO_DO_INIT";
