package com.hwx.safelock.safelock.weight;

import android.content.Context;
import android.util.AttributeSet;
import android.widget.VideoView;

public class FullScreenWebView extends VideoView {

    public FullScreenWebView(Context context, AttributeSet attrs, int defStyle) {
